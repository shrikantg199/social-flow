...
export function Header({ currentUser }: HeaderProps) {
  ...
  return (
    <motion.header
      ...
      className="fixed top-0 left-[250px] right-0 z-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50"
    >
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={cn(
                ...
                isSearchFocused && "w-full sm:w-[400px]"
              )}
            />
          </div>
        </div>
